<template>
  <div>
    <!-- 导航栏 -->
    <el-menu id="header" :default-active="activeIndex" class="header-container" mode="horizontal" @select="handleSelect">
      <el-menu-item index="/">菜单</el-menu-item>
      <el-menu-item index="2-2">爱好（可替换）</el-menu-item>
      <el-menu-item index="2-3">个人信息</el-menu-item>
      <el-menu-item index="2-4">登陆/注册</el-menu-item>
      <!-- github默认在新标签页打开 -->
